...
const struct Notification EMPTY_NOTIFICATION = {
        NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL
};

/* View a Pub/Sub notification configuration on a given bucket
 * GET https://storage.googleapis.com/storage/v1/b/bucket/notificationConfigs/notification
 * https://cloud.google.com/storage/docs/json_api/v1/notifications/get */
struct OptionalNotification
get_notification_configuration(const struct configuration *config, const char *id) {
    char *path;
