...
const struct Notification notificationNull = {NULL, NULL, NULL, NULL,
                                              NULL, NULL, NULL, NULL};
 ...
 * */
struct OptionalNotification
insert_bucket_notification(const char *const bucket_name,
...
notification_response_handler(const struct ServerResponse *const response) {
  ...
  optional_notification.notification = notificationNull;
