...
extern GOOGLE_CLOUD_C_TOPIC_EXPORT enum Encoding str_to_Encoding(const char *);

extern GOOGLE_CLOUD_C_TOPIC_EXPORT const char *Encoding_to_str(enum Encoding);
...
extern GOOGLE_CLOUD_C_TOPIC_EXPORT const struct Topic EMPTY_TOPIC;

/* Gets the configuration of a topic.
 * https://cloud.google.com/pubsub/docs/reference/rest/v1/projects.topics/get
 */
extern GOOGLE_CLOUD_C_TOPIC_EXPORT struct OptionalTopic get_topic(const char *);

/* Creates the given topic with the given name.
 * https://cloud.google.com/pubsub/docs/reference/rest/v1/projects.topics/create
 */
extern GOOGLE_CLOUD_C_TOPIC_EXPORT struct OptionalTopic
create_topic(const char *, struct Topic);

/* Deletes the topic with the given name.
 * https://cloud.google.com/pubsub/docs/reference/rest/v1/projects.topics/delete
 * */
extern GOOGLE_CLOUD_C_TOPIC_EXPORT bool delete_topic(const char *topic_id);

/* utility functions */

extern GOOGLE_CLOUD_C_TOPIC_EXPORT struct Topic
topic_from_json(const JSON_Object *);

extern GOOGLE_CLOUD_C_TOPIC_EXPORT const char *topic_to_json(struct Topic);
