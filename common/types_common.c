...
const struct StatusAndCstrAndCStr StatusAndCstrAndCStrNull = {EXIT_FAILURE,
                                                              NULL, 0, NULL, 0};

const struct StatusAndCstr StatusAndCstrNull = {EXIT_FAILURE, NULL, 0};

void cleanup_struct_cstr_array(
    struct StatusAndArrayCStrArray *status_and_array) {
...
void cleanup_struct_cstr_cstr(
    struct StatusAndCstrAndCStr *status_and_cstr_and_cstr) {
